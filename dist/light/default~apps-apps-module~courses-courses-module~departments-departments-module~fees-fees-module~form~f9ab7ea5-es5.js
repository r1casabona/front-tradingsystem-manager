  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015PaginatorJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function (_MatPaginatorBase2) {
      ...
      function MatPaginator(_intl, _changeDetectorRef, defaults) {
        ...
        _this17._intlChanges = _intl.changes.subscribe(
        /**
        * @return {?}
        */
        function () {
    ...
    function (_MatSelectMixinBase2) {
      ...
      function MatSelect(_viewportRuler, _changeDetectorRef, _ngZone, _defaultErrorStateMatcher, elementRef, _dir, _parentForm, _parentFormGroup, _parentFormField, ngControl, tabIndex, scrollStrategyFactory, _liveAnnouncer, defaults) {
        ...
        */
        ...
        _this18.optionSelectionChanges =
        /** @type {?} */
        ...
        */
        function () {
          ...
          return _this18._ngZone.onStable.asObservable().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["switchMap"])(
          /**
          * @return {?}
          */
          function () {
        ...
        _this18._openedStream = _this18.openedChange.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["filter"])(
        /**
        * @param {?} o
        * @return {?}
        */
        ...
        */
        ...
        _this18._closedStream = _this18.openedChange.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_13__["filter"])(
        /**
        * @param {?} o
        * @return {?}
        */
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015TooltipJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _hammerLoader) {
        ...
        */
        function (event) {
          if (_this37._isTooltipVisible() && event.keyCode === _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_7__["ESCAPE"] && !Object(_angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_7__["hasModifierKey"])(event)) {
            event.preventDefault();
      ...
      _createClass(MatTooltip, [{
          ...
          */
          function (change) {
            if (_this39._tooltipInstance) {
              if (change.scrollableViewProperties.isOverlayClipped && _this39._tooltipInstance.isVisible()) {
            ...
            */
            function () {
              if (_this40._tooltipInstance) {
                /** @type {?} */
                _this40._overlayRef.updatePosition();
              }
            });
          }
        }
        ...
        value: function _setupPointerEvents() {
          ...
          if (!this._platform.IOS && !this._platform.ANDROID) {
            ...
            */
            function touchendListener() {
              clearTimeout(_this41._touchstartTimeout);

              _this41.hide(_this41._defaultOptions.touchendHideDelay);
            };
            ...
            */
            function () {
              ...
              clearTimeout(_this41._touchstartTimeout);
              _this41._touchstartTimeout = setTimeout(
              /**
              * @return {?}
              */
              function () {
          ...
          */
          function (listener, event) {
            _this41._elementRef.nativeElement.addEventListener(event, listener, passiveListenerOptions);
          });
        }
        /**
          ...
          if (!this._message && this._isTooltipVisible()) {
            ...
            */
            function () {
              ...
              */
              function () {
                _this42._ariaDescriber.describe(_this42._elementRef.nativeElement, _this42.message);
              });
            });
          }
        }
    ...
    function () {
      ...
      _createClass(TooltipComponent, [{
        ...
        value: function show(delay) {
          ...
          */
          function () {
            _this43._visibility = 'visible';
            _this43._showTimeoutId = null; // Mark for check so if any parent component has set the
        ...
        value: function hide(delay) {
          ...
          */
          function () {
            _this44._visibility = 'hidden';
            _this44._hideTimeoutId = null; // Mark for check so if any parent component has set the
            // ChangeDetectionStrategy to OnPush it will be checked anyways
